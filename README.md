...
7 | Form Validation #4 | Enter Short Password | DIsplays Relevent Error Msg
8 | Form Validation #5 | Enter Password Without Number | Displays Relevent Error Msg
9 | Submit Form | Click Submit | Submits form, displays difficulty window
10 | Continue As Guest | Click Continue As Guest | Hides form without submitting, displays difficulty window
