...
2 | Sign-Up Toggle Button | Click Sign-Up | Reveals Sign-Up Window, displays Confirm Password field
3 | Form Validation #1 | Enter Short Username | Displays Relevent Error Msg
4 | Form Validation #2 | Enter Username without Number | Displays Relevent Error Msg
5 | Form Validation #3 | Enter Different Passwords | Displays Relevent Error Msg
6 | Form Validation #4 | Enter Short Password | DIsplays Relevent Error Msg
7 | Form Validation #5 | Enter Password Without Number | Displays Relevent Error Msg
8 | Submit Form | Click Submit | Submits form, displays difficulty window
9 | Continue As Guest | Click Continue As Guest | Hides form without submitting, displays difficulty window
